...
/** @type {number} Offsets for the star's spinning, I don't think this even works but idk */
var timeOffsets02 = [];
...
function setup_level_select() {
	...
	// Initialize buttons for level switching
	for (let i = 0; i < state.levels.length; i++) {
		timeOffsets02.push(random(0, TAU))
		// Basic button
		let _ = new Button(
			() => {
				state.active = true;
		...
		// Make the button not work if the level is locked
		...
		// If the level is completed change the display function to be green
